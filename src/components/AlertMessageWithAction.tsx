...
const AlertMessageWithAction: React.FC = () => {
    return (
        <div className="w-full h-full flex flex-col gap-4">
            ...
            <div className="p-3 flex items-center justify-between bg-[#e5f6fd] rounded">
                <div className="flex items-center gap-3">
                    ...
                    <p className="text-[#2d9dda] text-[1rem]">This is an info Alert.</p>
                </div>
            ...
            <div className="p-3 flex items-center justify-between bg-[#fdeded] rounded">
                <div className="flex items-center gap-3">
                    ...
                    <p className="text-[#d74242] text-[1rem]">This is an error Alert.</p>
                </div>
